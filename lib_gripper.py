# THIS FILE IS TAKEN FROM ONROBOT PYPI LIBRARY. AS IT WAS I COULDN'T USE IT SO I MADE SOME SMALL CHANGES TO THE CODE.

import requests
import xmlrpc.client

class RG2:
    def __init__(self, ip="192.168.1.105", rg_id: int = 0) -> None:
        self.rg_id = rg_id
        self.ip = ip
    ...
    <methodCall>
        ...
        try:
            response = requests.post(f'http://{self.ip}:41414', headers=headers, data=data)
